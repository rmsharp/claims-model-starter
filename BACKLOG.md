...
- [ ] **`protocol.py:34` docstring MAX_QUESTIONS lag** — `src/model_project_constructor/agents/intake/protocol.py:34` says "the hard **10-question** cap from §4.1" but `state.py:57` is `MAX_QUESTIONS = 20` (since Session 27). Source-code docstring drift, out of scope for the Session 40 wiki sweep. Micro fix: update the docstring to "20-question cap" (parallel to Session 40's F1 wiki fix).
