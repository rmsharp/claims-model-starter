...
defect the trim was scoped to remove, relocated rather than eliminated. **Sessions 224, 228, 231, 235, 239 and 242 widened this:**
there are now **seven** unwatched shards. The second, `SESSION_NOTES-S220-through-S217.md` (804 lines), the
...
`SESSION_NOTES-S235-through-S232.md` (1,057 lines), and the seventh,
`SESSION_NOTES-S238-through-S236.md` (644 lines), are all under the cap today, so they read
