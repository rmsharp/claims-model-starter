...
defect the trim was scoped to remove, relocated rather than eliminated. **Sessions 224, 228 and 231 widened this:**
there are now **four** unwatched shards. The second, `SESSION_NOTES-S220-through-S217.md` (804 lines), the
third, `SESSION_NOTES-S224-through-S221.md` (933 lines), and the fourth,
`SESSION_NOTES-S227-through-S225.md` (790 lines), are all under the cap today, so they read
